...
//    @Query("""
//       select c.id as id, c.text as text, c.date as date, c.altered as altered,
//            c.user.id as userId, c.user.nickname as userNickname, c.user.avatar as userAvatar,
...
//    Page<CommentRepliesView> findCommentReplies(Long parentCommentId, Pageable pageable);
    ...
    Page<ArticleComment> findAll(Long articleId, Pageable pageable);
