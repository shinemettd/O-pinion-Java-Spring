...
public interface CommentService {
    ResponseEntity<Page<CommentView>> getRootComments(Long articleId, Pageable pageable);
    ResponseEntity<Page<CommentRepliesView>> getCommentReplies(Long id, Pageable pageable);
